         ...
         <div class="container">
             ...
             <div class="row">
                 <?php foreach ($hotel as $h) : ?>
                     <a href="<?= $h['link_berita']; ?>">
                         <div class="col-xl-4 col-lg-4 col-md-6">
                             <div class="single-place mb-30">
                                 <div class="place-img">
                                     <img src="<?php echo base_url('assets/media/' . $h['foto']) ?>" width="150" height="300" alt="">
                                 </div>
                                 <div class="place-cap">
                                     <div class="place-cap-top">
                                         <h3><a href="#"><?= $h['keterangan']; ?></a></h3>
                                         <p class="dolor"><?= $h['tarif']; ?><span>/ Person</span></p>
                                     </div>
                                     ...
                                     <br>
                                     <center><a href="<?php echo base_url() . 'user/formTransaksi/' . $h['id_tps']; ?>" class="btn border-btn">Keep with guide</a></center>
                                 </div>
                             </div>
                         </div>
                     </a>
