<main>
    ...
    <div class="slider-area ">
        <!-- Mobile Menu -->
        <div class="single-slider slider-height2 d-flex align-items-center" data-background="<?= base_url('vendor/'); ?>assets/img/hero/about.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                    ...
                    <div class="right-caption">
                        ...
                        <div class="support-caption">
                            <p>Munduk Singaraja Village is a village that must be visited because of its beauty. This village is often dubbed the village above the clouds by visiting tourists.
                                ...
                                Munduk Singaraja Village was just promoted as a tourist village by Nyoman Bagiarta, a former head of the Tourism Education and Training Center in Denpasar in 1990. The main attraction of Munduk Village is its natural beauty, in this village there are coffee, tea and clove plantations.</p>
                ...
                <div class="col-xl-11 col-lg-11 col-md-9">
                    <div class="h1-testimonial-active">
                        ...
                        <div class="single-testimonial text-center">
                            ...
                            <div class="testimonial-caption ">
                                <div class="testimonial-top-cap">
                                    <p>Make your life first get your degree become who you want to be,
