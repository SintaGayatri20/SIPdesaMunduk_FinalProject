                     ...
                     <a href="<?= $r['link_berita']; ?>">
                         <div class="col-xl-4 col-lg-4 col-md-6">
                             <div class="single-place mb-30">
                                 <div class="place-img">
                                     <img src="<?php echo base_url('assets/media/' . $r['foto']) ?>" width="150" height="300" alt="">
                                 </div>
                                 <div class="place-cap">
                                     ...
                                     <br>
                                     <center><a href="<?php echo base_url() . 'user/formTransaksi/' . $r['id_tps']; ?>" class="btn border-btn">Keep with guide</a></center>
                                 </div>
                             </div>
                         </div>
                     </a>
