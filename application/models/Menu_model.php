...
class Menu_model extends CI_Model
{
    ...
    public function getDataTransaksi()
    {
        ...
        /*$query = "SELECT tb_transaksi.*, tb_tempatwisata.*,tb_guide.*
                ...
                ";*/
        $query = "SELECT * FROM tb_transaksi a,tb_tempatwisata b, tb_guide c, user d
                  WHERE a.id_tps=b.id_tps AND a.id_guide=c.id_guide AND a.id_user=d.id";
        return $this->db->query($query)->result_array();
    }
    ...
    {
        //return $this->db->get_where($this->tb_transaksi, ["id_transaksi" => $id])->row();
        return $this->db->query("SELECT * FROM  tb_transaksi a,tb_tempatwisata b,tb_guide c 
        WHERE a.id_tps=b.id_tps AND a.id_guide=c.id_guide 
        AND a.id_transaksi=$id 
        ORDER BY waktu_order DESC")->row();
    }
    ...
    public function getInvoice()
    {
        ...
        AND a.id_guide=c.id_guide AND a.id_user=$user_id 
        ORDER BY waktu_order DESC")->result_array();
    }
